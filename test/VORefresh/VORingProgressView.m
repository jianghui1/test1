...
- (instancetype)init{
	return [self initWithFrame:CGRectMake(0, 0, 30, 30) andLineColor:[UIColor redColor] andLineBgColor:[UIColor clearColor]];
}

- (instancetype)initWithFrame:(CGRect)frame{
	return [self initWithFrame:frame andLineColor:[UIColor redColor] andLineBgColor:[UIColor clearColor]];
}
...
- (void)setupRingAnimationLayer{
	...
	ringBgLayer.strokeColor   = [self.lineBgColor colorWithAlphaComponent: 0.0].CGColor;
...
- (void)setupTextAnimationLayer{
	...
	[text addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:self.bounds.size.width * 0.5] range:NSMakeRange(0, text.length)];
	...
	textBgLayer.fillColor     = [UIColor lightGrayColor].CGColor;
	textBgLayer.lineWidth     = self.lineWidth / 9;
    ...
    textAnimLayer.fillColor     = [UIColor lightGrayColor].CGColor;
