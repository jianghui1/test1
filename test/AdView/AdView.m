...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _rightImageView.autoresizingMask = UIViewAutoresizingFlexibleHeight;
...
+ (id)adScrollViewWithFrame:(CGRect)frame imageLinkURL:(NSMutableArray *)imageLinkURL pageControlShowStyle:(UIPageControlShowStyle)PageControlShowStyle
{
...
+ (id)adScrollViewWithFrame:(CGRect)frame imageLinkURL:(NSMutableArray *)imageLinkURL placeHoderImageName:(NSString *)imageName pageControlShowStyle:(UIPageControlShowStyle)PageControlShowStyle
{
...
+ (id)adScrollViewWithFrame:(CGRect)frame localImageLinkURL:(NSMutableArray *)imageLinkURL pageControlShowStyle:(UIPageControlShowStyle)PageControlShowStyle
{
    NSMutableArray * imagePaths = [[NSMutableArray alloc]init];
    for (NSString * imageName in imageLinkURL)
    {
...
- (void)setimageLinkURL:(NSMutableArray *)imageLinkURL
{
    ...
    if (imageLinkURL.count > 0 ) {
        ...
        centerImageIndex = 0;
        rightImageIndex  = imageLinkURL.count > 1 ? 1 : 0;
...
- (void)setAdTitleArray:(NSMutableArray *)adTitleArray withShowStyle:(AdTitleShowStyle)adTitleStyle
{
...
//    _pageControl.currentPageIndicatorTintColor = RGBColorAlpha(37, 158, 147, 1);
